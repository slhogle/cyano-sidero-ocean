...
```{bash}
grep "^Cruise" ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GEOTRACES_IDP2017_v2_Discrete_Sample_Data_c2f9b27_3.txt > ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GA10_bottle.tsv

grep "^GA10" ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GEOTRACES_IDP2017_v2_Discrete_Sample_Data_c2f9b27_3.txt >> ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GA10_bottle.tsv
```
...
```{r message=FALSE, warning=FALSE}
GA10.btl <- read_tsv(here::here("data", "geotraces", "GEOTRACES_IDP2017_v2_Discrete_Sample_Data", 
...
```{r}
write_tsv(GA10.wide, here::here("data", "intermediate_files", "GA10_mg_bottle.tsv"))
```
