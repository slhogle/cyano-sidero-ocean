...
```{bash}
grep "^Cruise" ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GEOTRACES_IDP2017_v2_Discrete_Sample_Data_c2f9b27_3.txt > ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GP13_bottle.tsv

grep "^GP13" ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GEOTRACES_IDP2017_v2_Discrete_Sample_Data_c2f9b27_3.txt >> ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GP13_bottle.tsv
```
...
```{r message=FALSE, warning=FALSE}
GP13.btl <- read_tsv(here::here("data", "geotraces", "GEOTRACES_IDP2017_v2_Discrete_Sample_Data", 
...
```{r}
write_tsv(GP13.wide, here::here("data", "intermediate_files", "GP13_mg_bottle.tsv"))
```
