...
```{bash}
grep "^Cruise" ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GEOTRACES_IDP2017_v2_Discrete_Sample_Data_c2f9b27_3.txt > ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GA03_bottle.tsv

grep "^GA03" ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GEOTRACES_IDP2017_v2_Discrete_Sample_Data_c2f9b27_3.txt >> ../data/geotraces/GEOTRACES_IDP2017_v2_Discrete_Sample_Data/GA03_bottle.tsv
```
...
```{r message=FALSE, warning=FALSE}
GA03.btl <- read_tsv(here::here("data", "geotraces", "GEOTRACES_IDP2017_v2_Discrete_Sample_Data", 
...
```{r}
write_tsv(GA03.wide, here::here("data", "intermediate_files", "GA03_mg_bottle.tsv"))
```
